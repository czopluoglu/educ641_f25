...
|-----------|----------|----------|
| `qnorm(p, mean, sd)` | Returns the value of X where the cumulative probability equals `p` | `qnorm(0.90, mean = 50, sd = 10)` → 66.45 |
]
...
In our demo, we treated 180 countries as our population, and the population mean and astandard deviation for life expectanct was 
