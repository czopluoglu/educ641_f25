...
### When do we look at relationships between two categorical variables?

- When **both variables** in your research question are **categorical**  
  (measured on a **nominal** or **ordinal** scale).
  
- When you want to know whether belonging to one category relate to belonging to another.
...
- Is **access to advanced coursework** (*enrolled in AP/IB* / *not enrolled*)  related to **school socioeconomic context** (*high-income*, *mid-income*, *low-income districts*)? 
